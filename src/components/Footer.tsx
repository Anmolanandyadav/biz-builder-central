        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><a href="#" className="hover:text-foreground transition-colors">Investment Opportunities</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><a href="#" className="hover:text-foreground transition-colors">Business Planning</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Funding Support</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><a href="#" className="hover:text-foreground transition-colors">Business Courses</a></li>
